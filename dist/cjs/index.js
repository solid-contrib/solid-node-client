      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (!(protocol === 'https' && typeof this.handlers.https === 'string')) return [3
            /*break*/
            , 4];
            if (!(this.handlers.https === 'solid-client-authn-node')) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
          ...
          case 2:
            ...
            /*yield*/
            , Promise.resolve().then(function () {
              return __importStar(require('./NssAuthSession'));
            })];
          ...
          case 4:
            ...
            return [4
            /*yield*/
            , this.handlers[protocol].login(credentials)];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , this.getSession(protocol)];

          case 1:
            session = _a.sent();
            if (!session.info.isLoggedIn) return [3
            /*break*/
            , 3];
            return [4
            /*yield*/
